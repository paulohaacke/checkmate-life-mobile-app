...
angular.module('checkmatelife.controllers')
    .controller('DashboardCtrl', ['$scope', 'TasksFactory', 'tasks', 'goals', 'lifeAreas', 'TASK_STATES', 'METRIC_TYPE', '$state', function($scope, TasksFactory, tasks, goals, lifeAreas, TASK_STATES, METRIC_TYPE, $state) {
